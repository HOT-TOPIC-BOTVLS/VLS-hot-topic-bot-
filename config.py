...
MIN_MUTE_DURATION = 5 * 60  # 5 minutes in seconds
MOD_MAX_MUTE = 7 * 24 * 60 * 60  # 7 days
ADMIN_MAX_MUTE = 30 * 24 * 60 * 60  # 30 days

# Raid Detection Configuration
DEFAULT_RAID_JOIN_THRESHOLD = 10
DEFAULT_RAID_WINDOW = 60  # seconds
DEFAULT_RAID_PATTERN_COUNT = 5
RAID_LOCKDOWN_DURATION = 5 * 60  # 5 minutes

# Music Configuration
MUSIC_INACTIVITY_TIMEOUT = 30 * 60  # 30 minutes
MUSIC_STATE_SAVE_INTERVAL = 30  # seconds

# Rate Limiting
SECURITY_FAILURE_THRESHOLD = 5
SECURITY_FAILURE_WINDOW = 5 * 60  # 5 minutes
